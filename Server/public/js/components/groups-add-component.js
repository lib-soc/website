...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h1, file, 110, 16, 3502);
			...
			add_location(img, file, 111, 16, 3540);
			attr_dev(p, "class", "description");
			add_location(p, file, 112, 16, 3621);
			add_location(li0, file, 114, 20, 3759);
			add_location(li1, file, 115, 20, 3840);
			add_location(li2, file, 116, 20, 3948);
			add_location(ol, file, 113, 16, 3733);
			attr_dev(label0, "for", "address-input");
			add_location(label0, file, 118, 16, 4039);
			attr_dev(input0, "id", "address-input");
			attr_dev(input0, "type", "text");
			input0.readOnly = true;
			add_location(input0, file, 118, 61, 4084);
			add_location(br, file, 118, 133, 4156);
			attr_dev(label1, "for", "contact-input");
			add_location(label1, file, 119, 16, 4178);
			attr_dev(input1, "id", "contact-input");
			attr_dev(input1, "type", "text");
			add_location(input1, file, 119, 60, 4222);
			attr_dev(button, "id", "submit-button");
			add_location(button, file, 120, 16, 4303);
			...
			add_location(map_component, file, 121, 16, 4389);
			attr_dev(div0, "id", "text-container");
			add_location(div0, file, 109, 12, 3459);
			attr_dev(div1, "id", "container");
			add_location(div1, file, 107, 8, 3356);
		},
